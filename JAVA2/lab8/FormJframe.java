...
public class FormJframe extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboProvine.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Ha Noi", "Phu Tho", "Thai Binh", "Hai Phong", "Quang Ninh", " ", " " }));
        cboProvine.setName("cboProvine"); // NOI18N
        cboProvine.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cboProvineActionPerformed(evt);
            }
        });
    ...
    private void btnRegisterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegisterActionPerformed
        ...
        String province;
        province = (String) cboProvine.getSelectedItem();

        FileOutputStream fos = null;

            try {
                fos = new FileOutputStream("dulieu.txt", true);
                
                try { 
                    String text = name + "  " + birth + "  " + email + "  " + gioitinh + "  " + province + " \n";
    ...
    private void cboProvineActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboProvineActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cboProvineActionPerformed
